...
import OfflineMap from '../../sections/@dashboard/OfflineMap';
...
export default function MapWeather() {
    ...
    return (
        <React.Fragment>
            <Helmet title={"Harita Hava Durumu"} />
            <Typography variant="h3" gutterBottom>
                Haritadan Hava Durumu
            </Typography>
            ...
            <Divider my={6} sx={{ mb: 2 }} />

            <Grid container spacing={5} sx={{ p: 2 }}>
                <Grid item xs={4}>
                    <OfflineMap latitude="10" longitude="10" />
                </Grid>
                <Grid item xs={3}>
                    <WeatherWidget
            ...
            <Typography variant="h6" gutterBottom sx={{ p: 2, mt: 5 }}>
                {weather?.name} Hava Durumu Tahminleri
            </Typography>
